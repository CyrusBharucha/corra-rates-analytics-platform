"""
Prices a swap on any historical date where BoC Valet data exists, and
compares how the curve and risk profile looked across real episodes, e.g.
March 2020 vs. March 2022 vs. October 2023 vs. today.

The only logic here beyond the core engines is: resolving a requested date
to the nearest actual data date, and looping the pricing pipeline over
multiple dates for comparison.
"""
